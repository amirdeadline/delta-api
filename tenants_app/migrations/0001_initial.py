    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='customers_tags', to='tenants_app.sharetag')),
            ],
        ),
        migrations.CreateModel(
            name='DeletedTenant',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField()),
                ('tags', models.ManyToManyField(blank=True, related_name='sdwan_software_tags', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='sdwan_controllers', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dedicated', models.BooleanField(default=False)),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tenants_app.region')),
                ('tags', models.ManyToManyField(blank=True, related_name='sces', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dedicated', models.BooleanField(default=False)),
                ('region', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tenants_app.region')),
                ('tags', models.ManyToManyField(blank=True, related_name='sase_controllers', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='region',
            name='tags',
            field=models.ManyToManyField(blank=True, related_name='regions', to='tenants_app.sharetag'),
        ),
        migrations.CreateModel(
            name='Product',
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='products_tags', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='licenses', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='tenants_tags', to='tenants_app.sharetag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tenants_app.customer')),
                ('tags', models.ManyToManyField(blank=True, related_name='contacts_tags', to='tenants_app.sharetag')),
            ],
            options={
